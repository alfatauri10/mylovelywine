<?php
// Recupero eventuali messaggi d'errore dalla sessione
    ...
    <body class="body-login">
        <div class="container d-flex justify-content-center align-items-center min-vh-100 py-5">
            <div class="container-form text-center">
                ...
                <p class="login-subtitle" style="margin-bottom: 25px;">Stai modificando: <strong><?php echo htmlspecialchars($vino['nome_vino']); ?></strong></p>
                ...
                <form action="modificaVinoController.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group text-start">
                                ...
                                <input type="number" name="anno" class="form-control-custom" value="<?php echo htmlspecialchars($vino['anno']); ?>" required min="1800" max="2099">
                            </div>
                        </div>
                    ...
                    <div class="form-group text-start mb-4">
                        <label class="form-label-custom">Sostituisci Foto Copertina (opzionale)</label>
                        <input type="file" name="copertina" class="form-control" accept="image/*" style="border-radius: 0; border: 1px solid #eeeae3; font-size: 0.8rem; color: #8c8479; padding: 10px;">
                    </div>

                    <div class="form-group text-start mb-4">
                        <label class="form-label-custom">Aggiungi Foto Galleria</label>
                        <input type="file" name="galleria[]" class="form-control" accept="image/*" multiple style="border-radius: 0; border: 1px solid #eeeae3; font-size: 0.8rem; color: #8c8479; padding: 10px;">
                    </div>
